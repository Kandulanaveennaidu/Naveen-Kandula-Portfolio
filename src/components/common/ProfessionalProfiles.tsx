...
import { Github, Linkedin, MessageSquare, Mail, ArrowUpRight, ExternalLink } from "lucide-react";
        ...
        {professionalProfiles.map((item) => {
          ...
          return (
            <a
              ...
              className="p-5 rounded-2xl bg-bg-card border border-border-subtle hover:border-white/20 transition-all duration-300 hover:shadow-card-glow group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[11px] font-mono uppercase px-2 py-0.5 rounded bg-white/[0.04] text-accent-cyan">
                    {item.label}
                  </span>
                </div>

                <h4 className="text-base font-bold text-text-primary tracking-tight mb-1 group-hover:text-white transition-colors">
                  {item.title}
                </h4>

                <p className="text-xs font-mono text-text-muted mb-3 truncate">
                  {item.handle}
                </p>
              ...
              <div className="pt-3 border-t border-border-subtle flex items-center justify-between text-xs font-semibold text-accent-primary group-hover:text-white transition-colors">
