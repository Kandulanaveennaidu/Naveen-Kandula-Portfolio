...
export default function Engagement() {
  return (
    <section 
      ...
      aria-label="Freelance Engagement Models"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
          {engagementModels.map((model) => (
            <div
              key={model.id}
              className="p-5 sm:p-7 rounded-2xl bg-bg-card border border-border-subtle hover:border-white/20 transition-all flex flex-col justify-between group"
            >
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-text-primary tracking-tight mb-2 group-hover:text-white transition-colors">
                  {model.title}
                </h3>
